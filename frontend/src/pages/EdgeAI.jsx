...
import intelCoreUltraBadges from '../assets/images/edge-ai/intel-core-ultra-series-2-badges.webp';
...
function ZevricHero() {
  return (
    <section className="zevric-shared-hero zevric-shared-hero--edge-ai">
      <div className="site-container zevric-shared-hero__inner">
        <div className="zevric-shared-hero__copy edge-surface-motif edge-surface-motif--contour">
          <h1 tabIndex="-1">Local AI processing on Zevric</h1>
          <p>Zevric processes video and sensor data on site while customers and integrators choose the runtime, models, applications and workflows.</p>
        ...
        <div className="zevric-shared-hero__visual">
          <div className="zevric-shared-hero__processor">
            <img src={intelCoreUltraBadges} alt="Intel Core Ultra 5, 7 and 9 processor badges" loading="eager" decoding="async" />
          </div>
          <img src={edgeAIHeroImage} alt="ZMD Zevric Compact Edge System in a precision electronics facility" loading="eager" decoding="async" fetchPriority="high" />
        </div>
      </div>
    </section>
  );
...
const assets = { edgeAIApplicationHealthcare, edgeAIApplicationIndustrial, edgeAIApplicationSite, edgeAIApplicationVideo };
